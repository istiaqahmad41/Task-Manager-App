...
import 'package:to_do_now/components/todo_tiles.dart';
      ...
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              Center(child: Text('Add a new task to complete!')),
              Center(child: MyButton(text: 'Add Task', OnPressed: creatNewTask))
            ],
          )),
    );
  }
